...
$obj2 = $stmt2->fetch(PDO::FETCH_OBJ);
  ...
  //   echo('<br>_'.$offset_left);
      
    //echo('>'.$Item_ProdMainDep.'_'.$Product_Main_Image_Key);
...
function scaleSize($maxW, $maxH, $currW, $currH) { // image is a reference to an <img> element
     $x = $maxW; // max width
         $y = $maxH; // max height
         $imageWidth = $currW;
         $imageHeight = $currH;
